...
export const slideNames = Object.freeze([
	...
	'SLL', 'SLR',
	'SF_',
] satisfies Record<SlideType, keyof typeof Def>);
...
const f = <
	V extends number, E extends string, N extends string, T extends NotesTypeId.Def | null, S extends SlideType | null,
...
export const data = Object.freeze({
	0: f(0, 'VERSION', 'バージョン', null, null, 2, Ma2Category.MA2_Header, 0, 0),
	1: f(1, 'FES_MODE', '宴モード', null, null, 1, Ma2Category.MA2_Header, 2),
	2: f(2, 'BPM_DEF', '基本BPM', null, null, 4, Ma2Category.MA2_Header, 1, 1, 1, 1/*, 1*/), // 我觉得是日本人写错了。
	3: f(3, 'MET_DEF', '基本拍数', null, null, 2, Ma2Category.MA2_Header, 2, 2),
	4: f(4, 'RESOLUTION', '解像度', null, null, 1, Ma2Category.MA2_Header, 2),
	5: f(5, 'CLK_DEF', '初期クリック', null, null, 1, Ma2Category.MA2_Header, 2),
	6: f(6, 'COMPATIBLE_CODE', '互換コード', null, null, 1, Ma2Category.MA2_Header, 0),
	7: f(7, 'BPM', 'BPM変更', null, null, 3, Ma2Category.MA2_Composition, 2, 2, 1),
	8: f(8, 'MET', '拍変更', null, null, 4, Ma2Category.MA2_Composition, 2, 2, 2, 2),
	9: f(9, 'CLK', 'クリック音', null, null, 2, Ma2Category.MA2_Composition, 2, 2),
	10: f(10, 'TAP', 'タップ', NotesTypeId.Def.Tap, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	11: f(11, 'BRK', 'ブレイク', NotesTypeId.Def.Break, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	12: f(12, 'XTP', 'EXタップ', NotesTypeId.Def.ExTap, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	13: f(13, 'HLD', 'ホールド', NotesTypeId.Def.Hold, null, 4, Ma2Category.MA2_Note, 2, 2, 2, 2),
	14: f(14, 'XHO', 'EXホールド', NotesTypeId.Def.ExHold, null, 4, Ma2Category.MA2_Note, 2, 2, 2, 2),
	15: f(15, 'STR', '☆', NotesTypeId.Def.Star, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	16: f(16, 'BST', 'ブレイク☆', NotesTypeId.Def.BreakStar, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	17: f(17, 'XST', 'EX☆', NotesTypeId.Def.ExStar, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	18: f(18, 'TTP', 'タッチタップ', NotesTypeId.Def.TouchTap, null, 6, Ma2Category.MA2_Note, 2, 2, 2, 3, 2, 4),
	19: f(19, 'THO', 'タッチホールド', NotesTypeId.Def.TouchHold, null, 7, Ma2Category.MA2_Note, 2, 2, 2, 2, 3, 2, 4),
	...
	33: f(33, 'T_REC_TAP', 'レコード数(TAP)', null, null, 1, Ma2Category.MA2_Total, 2),
	34: f(34, 'T_REC_BRK', 'レコード数(BRK)', null, null, 1, Ma2Category.MA2_Total, 2),
	35: f(35, 'T_REC_XTP', 'レコード数(XTP)', null, null, 1, Ma2Category.MA2_Total, 2),
	36: f(36, 'T_REC_HLD', 'レコード数(HLD)', null, null, 1, Ma2Category.MA2_Total, 2),
	37: f(37, 'T_REC_XHO', 'レコード数(XHO)', null, null, 1, Ma2Category.MA2_Total, 2),
	38: f(38, 'T_REC_STR', 'レコード数(STR)', null, null, 1, Ma2Category.MA2_Total, 2),
	39: f(39, 'T_REC_BST', 'レコード数(BST)', null, null, 1, Ma2Category.MA2_Total, 2),
	40: f(40, 'T_REC_XST', 'レコード数(XST)', null, null, 1, Ma2Category.MA2_Total, 2),
	41: f(41, 'T_REC_TTP', 'レコード数(TTP)', null, null, 1, Ma2Category.MA2_Total, 2),
	42: f(42, 'T_REC_THO', 'レコード数(THO)', null, null, 1, Ma2Category.MA2_Total, 2),
	43: f(43, 'T_REC_SLD', 'レコード数(SLD)', null, null, 1, Ma2Category.MA2_Total, 2),
	44: f(44, 'T_REC_ALL', 'レコード数(ALL)', null, null, 1, Ma2Category.MA2_Total, 2),
	45: f(45, 'T_NUM_TAP', 'アクション回数(TAP)', null, null, 1, Ma2Category.MA2_Total, 2),
	46: f(46, 'T_NUM_BRK', 'アクション回数(BRK)', null, null, 1, Ma2Category.MA2_Total, 2),
	47: f(47, 'T_NUM_HLD', 'アクション回数(HLD)', null, null, 1, Ma2Category.MA2_Total, 2),
	48: f(48, 'T_NUM_SLD', 'アクション回数(SLD)', null, null, 1, Ma2Category.MA2_Total, 2),
	49: f(49, 'T_NUM_ALL', 'アクション回数(ALL)', null, null, 1, Ma2Category.MA2_Total, 2),
	50: f(50, 'T_JUDGE_TAP', '判定数(TAP)', null, null, 1, Ma2Category.MA2_Total, 2),
	51: f(51, 'T_JUDGE_HLD', '判定数(HLD)', null, null, 1, Ma2Category.MA2_Total, 2),
	52: f(52, 'T_JUDGE_SLD', '判定数(SLD)', null, null, 1, Ma2Category.MA2_Total, 2),
	53: f(53, 'T_JUDGE_ALL', '判定数(ALL)', null, null, 1, Ma2Category.MA2_Total, 2),
	54: f(54, 'NMTAP', '通常タップ', NotesTypeId.Def.Tap, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	55: f(55, 'BRTAP', 'ブレイクタップ', NotesTypeId.Def.Break, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	56: f(56, 'EXTAP', 'EXタップ', NotesTypeId.Def.ExTap, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	57: f(57, 'BXTAP', 'EXブレイクタップ', NotesTypeId.Def.ExBreakTap, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	58: f(58, 'NMHLD', '通常ホールド', NotesTypeId.Def.Hold, null, 4, Ma2Category.MA2_Note, 2, 2, 2, 2),
	59: f(59, 'BRHLD', 'ブレイクホールド', NotesTypeId.Def.BreakHold, null, 4, Ma2Category.MA2_Note, 2, 2, 2, 2),
	60: f(60, 'EXHLD', 'EXホールド', NotesTypeId.Def.ExHold, null, 4, Ma2Category.MA2_Note, 2, 2, 2, 2),
	61: f(61, 'BXHLD', 'EXブレイクホールド', NotesTypeId.Def.ExBreakHold, null, 4, Ma2Category.MA2_Note, 2, 2, 2, 2),
	62: f(62, 'NMSTR', '通常☆', NotesTypeId.Def.Star, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	63: f(63, 'BRSTR', 'ブレイク☆', NotesTypeId.Def.BreakStar, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	64: f(64, 'EXSTR', 'EX☆', NotesTypeId.Def.ExStar, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	65: f(65, 'BXSTR', 'EXブレイク☆', NotesTypeId.Def.ExBreakStar, null, 3, Ma2Category.MA2_Note, 2, 2, 2),
	66: f(66, 'NMTTP', '通常タッチタップ', NotesTypeId.Def.TouchTap, null, 6, Ma2Category.MA2_Note, 2, 2, 2, 3, 2, 4),
	67: f(67, 'NMTHO', '通常タッチホールド', NotesTypeId.Def.TouchHold, null, 7, Ma2Category.MA2_Note, 2, 2, 2, 2, 3, 2, 4),
	...
	133: f(133, 'TTM_EACHPAIRS', 'eachペア数', null, null, 1, Ma2Category.MA2_Total, 2),
	134: f(134, 'TTM_SCR_TAP', 'TAPスコア', null, null, 1, Ma2Category.MA2_Total, 2),
	135: f(135, 'TTM_SCR_BRK', 'BREAKスコア', null, null, 1, Ma2Category.MA2_Total, 2),
	136: f(136, 'TTM_SCR_HLD', 'HOLDスコア', null, null, 1, Ma2Category.MA2_Total, 2),
	137: f(137, 'TTM_SCR_SLD', 'スライドスコア', null, null, 1, Ma2Category.MA2_Total, 2),
	138: f(138, 'TTM_SCR_ALL', '合計スコア', null, null, 1, Ma2Category.MA2_Total, 2),
	139: f(139, 'TTM_SCR_S', 'RankSスコア', null, null, 1, Ma2Category.MA2_Total, 2),
	140: f(140, 'TTM_SCR_SS', 'TTM_SCR_SS', null, null, 1, Ma2Category.MA2_Total, 2),
	141: f(141, 'TTM_RAT_ACV', 'TTM_RAT_ACV', null, null, 1, Ma2Category.MA2_Total, 2),

	// 看起来是日本人忘记塞进去了，我来仿写一个
	200: f(200, 'T_REC_BXX', 'レコード数(BXX)', null, null, 1, Ma2Category.MA2_Total, 2),
	201: f(201, 'T_REC_BHO', 'レコード数(BHO)', null, null, 1, Ma2Category.MA2_Total, 2),
	202: f(202, 'T_REC_BXH', 'レコード数(BXH)', null, null, 1, Ma2Category.MA2_Total, 2),
	203: f(203, 'T_REC_XBS', 'レコード数(XBS)', null, null, 1, Ma2Category.MA2_Total, 2),
	204: f(204, 'T_REC_BSL', 'レコード数(BSL)', null, null, 1, Ma2Category.MA2_Total, 2),

	[-1]: f(-1, 'Invalid', '', null, null, 0, Ma2Category.MA2_INVALID),
